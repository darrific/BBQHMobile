...
<section>
	...
	<div class="orderbanner hidden-xs hidden-sm">
		<a name="ordering"></a>
		<div class="row">
	...
	<div id="BigUIContainer" class="row">
		<div id="UIContainer" class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div id="fun_zebra_combinations" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				...
				<div id="fun_zebra_sides" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="bg_4 o9 col-lg-10 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0">
						<div class="row">
