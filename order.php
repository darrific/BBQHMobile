    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-menubuilder">
            <ul class="nav navbar-nav navbar-center col-lg-10 col-xl-10">
                ...
                <li class="col-lg-2 col-lg-offset-0 col-xl-2 col-xl-offset-0"><a style="color: rgba(227, 227, 227, 1); border-left:solid 1px #52AE3D; border-right:solid 1px #52AE3D;" href="order.php">Place An Order</a>
                </li>
                ...
                <li class="col-lg-1"><a id="cartli" href="cart.php"><img id="cartbutton" src="Icons Pack/SVG/shopping111.svg" alt="Cart"></a>
                </li>
            </ul>
        </div>
    </div>
